...
#define NETSNMP_CONFIGURE_OPTIONS " '--host=mips-linux-gnu' '--enable-ucd-snmp-compatibility' '--enable-shared' '--with-cflags=-O2 -D_REENTRANT -DNETSNMP_USE_INLINE -Wall' '--with-sys-contact=root' '--with-sys-location=Unknown' '--with-mib-modules=ucd-snmp/dlmod disman/event-mib' '--enable-mfd-rewrites' '--with-defaults' '--without-rpm' '--disable-embedded-perl' 'host_alias=mips-linux-gnu'"
...
#define NETSNMP_DEFAULT_MIBS ":UCD-DLMOD-MIB:IP-MIB:IF-MIB:TCP-MIB:UDP-MIB:HOST-RESOURCES-MIB:SNMPv2-MIB:RFC1213-MIB:NOTIFICATION-LOG-MIB:DISMAN-EVENT-MIB:DISMAN-SCHEDULE-MIB:UCD-SNMP-MIB:UCD-DEMO-MIB:SNMP-TARGET-MIB:NET-SNMP-AGENT-MIB:HOST-RESOURCES-TYPES:SNMP-MPD-MIB:SNMP-USER-BASED-SM-MIB:SNMP-FRAMEWORK-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:IP-FORWARD-MIB:NET-SNMP-PASS-MIB:NET-SNMP-EXTEND-MIB:SNMP-NOTIFICATION-MIB:SNMPv2-TM:NET-SNMP-VACM-MIB"
