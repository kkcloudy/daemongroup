 ...
 *       version : 14170 $ of $ 
 *
 * $Id: dot3StatsTable.c,v 1.2 2010/04/27 02:28:48 qiaojie Exp $
 */
...
static dot3StatsTable_registration dot3StatsTable_user_context;
...
init_dot3StatsTable(void)
{
	...
	//printf("has enter init_dot3StatsTable!\n");
    if (should_init("dot3StatsTable"))
        initialize_table_dot3StatsTable();

	//syslog(LOG_NOTICE, "has enter init_dot3StatsTable!");
	//printf("has enter init_dot3StatsTable!\n");
}                               /* init_dot3StatsTable */
