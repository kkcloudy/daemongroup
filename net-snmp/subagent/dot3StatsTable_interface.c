 ...
 *       version : 15899 $ of $ 
 *
 * $Id: dot3StatsTable_interface.c,v 1.2 2010/04/27 02:28:48 qiaojie Exp $
 */
/*
 * *********************************************************************
 * *********************************************************************
                                     ...
                                     u_long flags)
{
     ...
     */
     //printf("has out of dot3StatsTable_init_data called!!\n");
	...
	//printf("before _mfd_dot3StatsTable_get_values!!!\n");
    /*
	...
	//printf("after netsnmp_handler_registration_create!!!\n");
                           ...
                           netsnmp_variable_list * var, int column)
{
    ...
    case COLUMN_DOT3STATSALIGNMENTERRORS:
		...
		#endif
		printf("has enter get column COLUMN_DOT3STATSALIGNMENTERRORS-----\n");
                               ...
                               netsnmp_request_info *requests)
{
	...
	//printf("has enter _mfd_dot3StatsTable_get_values\n");
    for (; requests; requests = requests->next) {
        ...
        if (NULL == tri)
            continue;
		printf("_dot3StatsTable_get_column, tri->colnum=%d\n",tri->colnum);
