...
/**
 * initialization for dot11PermitSSIDTable data access
 *
 * This function is called during startup to allow you to
 * allocate any resources you need for the data table.
 *
 * @param dot11PermitSSIDTable_reg
 *        Pointer to dot11PermitSSIDTable_registration
 *
 * @retval MFD_SUCCESS : success.
 * @retval MFD_ERROR   : unrecoverable error.
 */
int
dot11PermitSSIDTable_init_data(dot11PermitSSIDTable_registration * dot11PermitSSIDTable_reg)
{
    DEBUGMSGTL(("verbose:dot11PermitSSIDTable:dot11PermitSSIDTable_init_data","called\n"));

    /*
     * TODO:303:o: Initialize dot11PermitSSIDTable data.
     */
    /*
    ***************************************************
    ***             START EXAMPLE CODE              ***
    ...
    ***************************************************/
    ...
    return MFD_SUCCESS;
} /* dot11PermitSSIDTable_init_data */
 ...
 */
void
dot11PermitSSIDTable_container_init(netsnmp_container **container_ptr_ptr,
                             netsnmp_cache *cache)
{
    DEBUGMSGTL(("verbose:dot11PermitSSIDTable:dot11PermitSSIDTable_container_init","called\n"));
    
    if (NULL == container_ptr_ptr) {
        snmp_log(LOG_ERR,"bad container param to dot11PermitSSIDTable_container_init\n");
        return;
    }
    ...
    *container_ptr_ptr = NULL;
    ...
    if (NULL == cache) {
        snmp_log(LOG_ERR,"bad cache param to dot11PermitSSIDTable_container_init\n");
        return;
    }

    /*
     * TODO:345:A: Set up dot11PermitSSIDTable cache properties.
     *
     ...
     * cache->enabled to 0.
     */
    cache->timeout = DOT11PERMITSSIDTABLE_CACHE_TIMEOUT; /* seconds */
 ...
 *
 *  This function is called before dot11PermitSSIDTable_container_free().
 *
 * @remark
 ...
 */
void
dot11PermitSSIDTable_container_shutdown(netsnmp_container *container_ptr)
{
    DEBUGMSGTL(("verbose:dot11PermitSSIDTable:dot11PermitSSIDTable_container_shutdown","called\n"));
    
    if (NULL == container_ptr) {
        snmp_log(LOG_ERR,"bad params to dot11PermitSSIDTable_container_shutdown\n");
        return;
    }

} /* dot11PermitSSIDTable_container_shutdown */
 ...
 */
void
dot11PermitSSIDTable_container_free(netsnmp_container *container)
{
    DEBUGMSGTL(("verbose:dot11PermitSSIDTable:dot11PermitSSIDTable_container_free","called\n"));

    /*
     * TODO:380:M: Free dot11PermitSSIDTable container data.
     */
} /* dot11PermitSSIDTable_container_free */
 ...
 */
int
dot11PermitSSIDTable_row_prep( dot11PermitSSIDTable_rowreq_ctx *rowreq_ctx)
{
    DEBUGMSGTL(("verbose:dot11PermitSSIDTable:dot11PermitSSIDTable_row_prep","called\n"));
    ...
    return MFD_SUCCESS;
} /* dot11PermitSSIDTable_row_prep */

/*
 * TODO:420:r: Implement dot11PermitSSIDTable index validation.
 */
/*---------------------------------------------------------------------
 * DOT11-AC-MIB::dot11PermitSSIDEntry.permitSSIDID
 * permitSSIDID is subid 1 of dot11PermitSSIDEntry.
 * Its status is Current, and its access level is ReadOnly.
 * OID: .1.3.6.1.4.1.31656.6.1.2.10.1.1
 * Description:
SSID permission ID.
 *
 * Attributes:
 ...
 */
/**
 * check validity of permitSSIDID index portion
 *
 ...
 *       dot11PermitSSIDTable_validate_index() function.
 *
 ...
 */
int
permitSSIDID_check_index( dot11PermitSSIDTable_rowreq_ctx *rowreq_ctx )
{
    DEBUGMSGTL(("verbose:dot11PermitSSIDTable:permitSSIDID_check_index","called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    /*
     * TODO:426:M: |-> Check dot11PermitSSIDTable index permitSSIDID.
     * check that index value in the table context is legal.
     * (rowreq_ctx->tbl_index.permitSSIDID)
     */

    return MFD_SUCCESS; /* permitSSIDID index ok */
} /* permitSSIDID_check_index */
 ...
 */
int
dot11PermitSSIDTable_validate_index( dot11PermitSSIDTable_registration * dot11PermitSSIDTable_reg,
                           dot11PermitSSIDTable_rowreq_ctx *rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(("verbose:dot11PermitSSIDTable:dot11PermitSSIDTable_validate_index","called\n"));

    /** we should have a non-NULL pointer */
    netsnmp_assert( NULL != rowreq_ctx );

    /*
     * TODO:430:M: |-> Validate potential dot11PermitSSIDTable index.
     */
    if(0) {
        snmp_log(LOG_WARNING,"invalid index for a new row in the "
                 "dot11PermitSSIDTable table.\n");
        /*
    ...
    return rc;
} /* dot11PermitSSIDTable_validate_index */
