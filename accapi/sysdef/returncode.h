...
#define DHCP_FAILOVER_STATE_RECOVER_FAIL_TO_BIND		(DHCP_SERVER_RETURN_CODE_BASE + 0X24)
...
#define BSD_RETURN_CODE_BASE                           (0x1c0000)
#define BSD_RETURN_CODE_SUCCESS                        (COMMON_SUCCESS)
#define BSD_RETURN_CODE_OK		                       (BSD_RETURN_CODE_BASE + 1)
#define BSD_RETURN_CODE_ERR		                       (BSD_RETURN_CODE_BASE + 2)
#define BSD_RETURN_CODE_MALLOC_FAILED                  (BSD_RETURN_CODE_BASE + 3)
#define BSD_RETURN_CODE_NULL_POINT                     (BSD_RETURN_CODE_BASE + 4)
#define BSD_RETURN_CODE_INIT_SOCKET_ERR                (BSD_RETURN_CODE_BASE + 5)
#define BSD_RETURN_CODE_INVAILD_SOCKET                 (BSD_RETURN_CODE_BASE + 6)
#define BSD_RETURN_CODE_FILE_OPEN_ERR                  (BSD_RETURN_CODE_BASE + 7)
#define BSD_RETURN_CODE_FILE_INFO_ERR                  (BSD_RETURN_CODE_BASE + 8)
#define BSD_RETURN_CODE_CREATE_DIR_FAILED              (BSD_RETURN_CODE_BASE + 9)
#define BSD_RETURN_CODE_GET_FILE_SIZE_ERROR            (BSD_RETURN_CODE_BASE + 0xA)
#define BSD_RETURN_C0DE_ESTABLISH_CONN_FAILED          (BSD_RETURN_CODE_BASE + 0xB)
#define BSD_RETURN_CODE_RECEIVE_MESSAGE_ERROR          (BSD_RETURN_CODE_BASE + 0xC)
#define BSD_RETURN_CODE_SEND_MESSAGE_ERROR             (BSD_RETURN_CODE_BASE + 0xD)
#define BSD_RETURN_CODE_ALREADY_SET                    (BSD_RETURN_CODE_BASE + 0xE)
#define BSD_RETURN_CODE_ILLEGAL_DEST_FILE_PATH         (BSD_RETURN_CODE_BASE + 0xF)
#define BSD_RETURN_CODE_ILLEGAL_SRC_FILE_PATH          (BSD_RETURN_CODE_BASE + 0x10)
#define BSD_RETURN_CODE_NOT_ENOUGH_MEMORY              (BSD_RETURN_CODE_BASE + 0x11)
#define BSD_RETURN_CODE_PEER_SAVE_FILE_ERROR           (BSD_RETURN_CODE_BASE + 0x12)
