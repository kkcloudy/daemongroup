...
#define AC_SAMPLE_DBUS_METHOD_SET_SAMPLE_PARAM_BY_NAME   	"ac_sample_dbus_method_set_sample_param_by_name"
#define AC_SAMPLE_DBUS_METHOD_GET_SAMPLE_PARAM_BY_NAME  	"ac_sample_dbus_method_get_sample_param_by_name"

#define AC_SAMPLE_DBUS_METHOD_GET_SAMPLE_PARAM_TIMEOUT			"ac_sample_dbus_method_get_sample_param_timeout"
#define AC_SAMPLE_DBUS_METHOD_SET_SAMPLE_PARAM_TIMEOUT			"ac_sample_dbus_method_set_sample_param_timeout"

#define AC_SAMPLE_DBUS_METHOD_GET_SAMPLE_PARAMS_INFO_BY_NAME	"ac_sample_dbus_method_get_sample_params_info_by_name"
...
#define AC_SAMPLE_DBUS_METHOD_GET_RADIUS_REQ_INFO   "ac_sample_dbus_method_get_radius_req_info"
//cpu info show out , added by stephen
#define AC_SAMPLE_DBUS_METHOD_GET_CPU_STAT_INFO		"ac_sample_dbus_method_get_cpu_stat_info"
#define AC_SAMPLE_DBUS_METHOD_GET_CPU_RT_STAT_INFO	"ac_sample_dbus_method_get_cpu_rt_stat_info"
//cpu rt info , added by stephen

int sample_tipc_session_init(void);
void sample_tipc_session_destroy(void);
manage_session *sample_get_tipc_session(void);

int  ac_sample_dbus_init(void);
void ac_sample_tipc_dbus_init(void);
void ac_sample_dbus_dispach( unsigned int block_usecond );

int ac_sample_dbus_send_signal( const char *signal_name, 
								int first_arg_type,...);

int ac_sample_dbus_send_active_signal(const char *signal_name, 
								                int first_arg_type,...);

DBusConnection *ac_sample_dbus_get_connection();
DBusConnection *ac_sample_dbus_get_slotconnection(int slotid);

DBusConnection *ac_sample_dbus_get_active_connection(void);
...
#define AC_SAMPLE_OVER_THRESHOLD_SIGNAL_DHCPUSAGE		"ac_sample_dhcpusage_over_threshold"
