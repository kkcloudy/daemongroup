...
/*add by shaojunwu */
static inline int is_entry_in_list(struct list_head *entry, struct list_head *head)
{
...
static inline int is_entry_in_hlist(struct hlist_node *entry, struct hlist_head *head)
{
