...
char HMD_DBUS_CONF_DELETE_AUTO_SYNC_CONFIG_IP[PATH_LEN] = "delete_auto_sync_config_ip";
...
char HMD_DBUS_CONF_SET_AUTO_SYNC_CONFIG[PATH_LEN] = "set_auto_sync_config";
