...
#define OSPF_DEFAULT_CONFIG_HOST        RTSUIT_CONF_PATH OSPF_DEFAULT_CONFIG
...
#define OSPF_DEFAULT_REF_BANDWIDTH	1000000  /* Kbps */
...
extern int ospf_area_no_summary_set (struct ospf *, struct in_addr ,int);
