...
bgp_vty_init (void)
{
  ...
  install_node (&bgp_node, bgp_config_write, "BGP_NODE");
  install_node (&bgp_ipv4_unicast_node, NULL, "BGP_IPV4_NODE");
  install_node (&bgp_ipv4_multicast_node, NULL, "BGP_IPV4M_NODE");
  install_node (&bgp_ipv6_unicast_node, NULL, "BGP_IPV6_NODE");
  install_node (&bgp_ipv6_multicast_node, NULL, "BGP_IPV6M_NODE");
  install_node (&bgp_vpnv4_node, NULL, "BGP_VPNV4_NODE");
...
{
  install_node (&community_list_node, community_list_config_write, "COMMUNITY_LIST_NODE");
