...
$ignore{'"router rtm"'} = "ignore";
$ignore{'"no router rtm"'} = "ignore";
...
foreach (@ARGV) {
    $file = $_;
    open (FH, "cpp -DHAVE_CONFIG_H -DVTYSH_EXTRACT_PL -DHAVE_IPV6 -I../ -I../../debsrc/quagga-0.99.5/vtysh/ -I../../debsrc/quagga-0.99.5/vtysh/.. -I../../debsrc/quagga-0.99.5/lib -I/opt/mipslibs/usr/include/net-snmp -I/opt/mipslibs/usr/include/net-snmp/library -I/opt/mipslibs/usr/include $file |");
    local $/; undef $/;
    $line = <FH>;
    close (FH);
