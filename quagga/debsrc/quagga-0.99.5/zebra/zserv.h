...
#define DEFAULT_CONFIG_FILE "rtmd.conf"
#define RTMD_DEFAULT_CONFIG_HOST        RTSUIT_CONF_PATH DEFAULT_CONFIG_FILE
...
//  struct list *tipc_client_list;
//  struct list *tipc_server_list;
	struct list *vice_board_list;
	struct list *master_board_list;
