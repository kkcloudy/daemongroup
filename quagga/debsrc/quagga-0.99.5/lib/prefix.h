...
#define PREFIXHOST (1<<0)
#define PREFIXCLASSA2C (1<<1)//not concidering the mask
#define PREFIXNORMAL (1<<2) //not null0,lp
extern int prefix_verify_ipv4(int,const struct prefix_ipv4*);
