...
#define TELNET_NAWS_SB_LEN 5
  ...
  FILE *fp ;
  /* zhanglei add Pre-Node status of this vty */
  int prenode;
  /* zhanglei add slot info status of this vty */
  int slotindex;
  /* zhanglei add slot info status of this vty */
  int slotindex1;
  int local;/*wuwl add local info status of this vty*/
};

/* Integrated configuration file. */
#define INTEGRATE_DEFAULT_CONFIG "rtsuit.conf"
...
/* Exported variables */
extern char integrate_default_bak[];  
extern char *integrate_default;
extern char *default_admin_user;
