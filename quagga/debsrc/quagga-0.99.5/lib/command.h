...
struct host_name
{
	char Host_name[HOSTNAME_MAX_LEN];
	int slotid;
	unsigned char flag;
};

#define HOSTNAME_DEFAULT 	"SYSTEM"
#define HOSTNAME_DEFAULT_FILE 	"/proc/sys/kernel/hostname"
#define HOSTNAME_SCOPE_FLAG_FILE 	"/var/run/hostname_scope"

#define HOSTNAEM_LOCAL		(1<<0)
/*#define HOSTNAME_GLOBAL	(1<<1)*/
...
struct host
{
  ...
  struct list *host_name_list;
  /*unsigned char host_name_flag;*/
...
enum node_type 
{
...
#ifdef _D_WCPSS_
	EBR_NODE, 			/*ethereal bridge*/
	HANSI_EBR_NODE,
	LOCAL_HANSI_EBR_NODE,
	CWTUNNEL_NODE,		/* CAPWAP data channel node */

#endif
  INTERFACE_NODE,		/* Interface mode node. */
  TRUNK_NODE,		/*TRUNK config node*/
  VLAN_NODE,		  /* VLAN config node. */ 
  DYNAMIC_TRUNK_NODE,	/* dynamic trunk config node*/ 
  PVLAN_NODE,
  VLAN_EGRESS_NODE,
  ETH_PORT_NODE, /* ETHERNET PORT config node */
	ACL_EGRESS_GROUP_NODE,/*egress ACL group config node*/
	ACL_GROUP_NODE, /* ACL group config node */
	QOS_PROFILE_NODE, 	/*qos profile node*/
	QOS_NODE, 	/*qos  node  for show running*/
  POLICY_NODE,			/*policy-map node*/
  POLICER_NODE,			/*policer node*/
  SHQUEUE_NODE,			/*scheduler queue */
  OUT_PROFILE_NODE,		/*out profile node*/
  TIME_RANGE_NODE,		/*time range*/
  MIRROR_NODE,		/*mirror node*/
  MST_NODE,			/*MSTP config node*/
  ...
  IRDP_NODE,			/* ICMP Router Discovery Protocol mode. */ 
	...
	IP_TUNNEL_NODE,			/* Static ipv6 tunnel node. */
  ...
  SPACIAL_CONFIG_NODE,
  HIDDENDEBUG_NODE,		/*hidden debug node*/
  SYSTEM_DEBUG_NODE,
  PIMD_NODE,
  QINQ_TYPE_NODE,
  DNSCACHE_NODE,/*modify by shaojunwu 2011-12-8*/
#ifdef _D_WCPSS_
	SECURITY_NODE,
	ACIPLIST_NODE,
	WLAN_NODE,			/* WLAN node */
	...
	RADIO_NODE,
	STA_NODE,
	WQOS_NODE,		/*wireless qos node.*/
  AC_GROUP_NODE,
	EBR_NODE1,  
	WLAN_NODE1, 		/* WLAN node */
	WTP_NODE1,
	AP_GROUP_NODE,
	AP_GROUP_WTP_NODE,
	AP_GROUP_RADIO_NODE,							//80
	HANSI_SECURITY_NODE,
	HANSI_ACIPLIST_NODE,
	HANSI_WLAN_NODE,			/* WLAN node */
	HANSI_WTP_NODE,
	HANSI_RADIO_NODE,
	HANSI_STA_NODE,
	HANSI_WQOS_NODE,		/*wireless qos node.*/
	HANSI_CWTUNNEL_NODE,
	HANSI_AP_GROUP_NODE,							//89
	HANSI_AP_GROUP_WTP_NODE,
	HANSI_AP_GROUP_RADIO_NODE,
	HANSI_POOL_NODE,			/* pool node */
	HANSI_POOLV6_NODE,
	HANSI_AC_GROUP_NODE,		/*wireless ac_group_node*/
	LOCAL_HANSI_SECURITY_NODE,
	LOCAL_HANSI_ACIPLIST_NODE,
	LOCAL_HANSI_WLAN_NODE,			/* WLAN node */
	LOCAL_HANSI_WTP_NODE,
	LOCAL_HANSI_RADIO_NODE,
	LOCAL_HANSI_STA_NODE,
	LOCAL_HANSI_WQOS_NODE,		/*wireless qos node.*/
	LOCAL_HANSI_CWTUNNEL_NODE,
	LOCAL_HANSI_AP_GROUP_NODE,							//89
	LOCAL_HANSI_AP_GROUP_WTP_NODE,
	LOCAL_HANSI_AP_GROUP_RADIO_NODE,
	LOCAL_HANSI_POOL_NODE,
	LOCAL_HANSI_POOLV6_NODE,
	LOCAL_HANSI_AC_GROUP_NODE,		/*wireless ac_group_node*/
	CBAT_NODE,
	CNU_NODE,
	HANSI_CBAT_NODE,
	HANSI_CNU_NODE,
...
/*  DNSCACHE_NODE,*/
  ...
  SYSLOG_NODE,
  WEBSERVICE_NODE,
  RADIUS_NODE,   /*add by liusheng ,for  radius server configuration*/
  PPPOE_NODE,
  ACINFO_NODE,
  HANSI_PPPOE_DEVICE_NODE,			/*add by lixiang , for new pppoe config */
 ...
 /*add by sunjc@autelan.com*/
  ...
  IU_NODE,
  IUH_NODE,
  WIRELESS_INTERFACE_NODE,/*gjd : add for wireless interface to write show running when Rtsuit restart.*/
  HANSI_IU_NODE,
  HANSI_IUH_NODE,
  LOCAL_HANSI_IU_NODE,
  LOCAL_HANSI_IUH_NODE,
  TIME_ZONE_NODE,
  /* distributed ACL, zhangdi@autelan.com 2011-11-24*/
...
#define CMD_DBUS_ERR_RETRY		11

/* Argc max counts. */
#define CMD_ARGC_MAX   25

/* show running config per line size */
...
/* Common descriptions. */
#define SETT_STR	"Set system configuration\n"
#define ACL_STR    "Configure acl rule\n"
#define QOS_STR     "Configure qos rule\n"
...
#define SER_TELNET_STR "Configuring Telnet service\n"
#define SER_STR "Configuring system service\n"
#define SER_SSH_STR "Configuring ssh service\n"
#define TCPDUMP_STR "dump traffic on a network\n"

#define SSHD_CONFIG_PATCH "/etc/ssh/sshd_config"
#define INETD_PATH "/etc/inetd.conf"
...
#define CONFIG_STR	"Config system configuration\n"
#define NO_CONFIG_STR	"Clear system configuration\n"
#define CONFIG_ETHPORT_STR "Config ethernet port number(e.g. 1/1 or 1-1 means slot 1 port 1)\n"
...
/*added by scx for pim 091217*/
#define MULTICAST_GROUP_STR 				"Multicast group\n"
#define MULTICAST_GROUP_IP_STR 				"Multicast group IP address\n"
#define MULTICAST_SOURCE_IP_STR 				"Multicast source IP address\n"
#define MULTICAST_ROUTE_STR 					"Multicast route information\n"
#define MULTICAST_SOURCE_STR 					"Multicast source information\n"
#define MULTICAST_STR 							"IP multicast forwarding\n"
...
/*gujd: 2012-02-23 , pm 3:30 . In order to decrease the warning when make img . Declare the func here. */
extern vector get_cmdvec();
...
#else
#define VTYSH_ALL	  VTYSH_ZEBRA|VTYSH_RIPD|VTYSH_RIPNGD|VTYSH_OSPFD|VTYSH_OSPF6D|VTYSH_ISISD
#define VTYSH_RMAP	  VTYSH_RIPD|VTYSH_RIPNGD|VTYSH_OSPFD|VTYSH_OSPF6D
#define VTYSH_INTERFACE	  VTYSH_ZEBRA|VTYSH_RIPD|VTYSH_RIPNGD|VTYSH_OSPFD|VTYSH_OSPF6D|VTYSH_ISISD
#endif
