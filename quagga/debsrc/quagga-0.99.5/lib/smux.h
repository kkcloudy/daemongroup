...
#define SMUX_MAX_FAILURE 1

/* Structures here are mostly compatible with UCD SNMP 4.1.1 */
#define MATCH_FAILED     (-1)
#define MATCH_SUCCEEDED  0

#define ENTERPRISE_SNMP_OID_FILE "/devinfo/enterprise_snmp_oid"
...
/*gujd : 2012-05-28, pm 2:49 . In order to decrease the warning when make img . For func declare */
extern void smux_stop();
