...
/*gujd: 2012-02-08: pm 5:20 . In order to decrease the warning when make img . For struct connected .*/
#include "if.h"
...
extern struct route_node *route_node_match (struct route_table *, 
                                            struct prefix *);
extern struct route_node *route_node_match_4rip (struct route_table *, 
                                            struct prefix *,struct connected *);
