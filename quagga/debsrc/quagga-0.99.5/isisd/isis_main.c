...
#define ISISD_DEFAULT_CONFIG_HOST        RTSUIT_CONF_PATH ISISD_DEFAULT_CONFIG
...
main (int argc, char **argv, char **envp)
{
  ...
  host_config_set (ISISD_DEFAULT_CONFIG_HOST );
  ...
  /* Print banner. */
  zlog_notice ("ISISd %s starting: vty@%d", QUAGGA_VERSION, vty_port);
