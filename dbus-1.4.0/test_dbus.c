...
void listen() 
{
   ...
   fprintf(stderr,"dbus_bus_get OK\n");
   if (NULL == conn) {
...
fprintf(stderr,"dbus_bus_request_name OK");
   // loop, testing for new messages
   while (true) {
   fprintf(stderr,"loop get signed\n");
