...
/*for show dhcp ipv6 information*/
struct dhcp6_lease_info{	
	unsigned char client_mac[6];	
	int ipv6_num;
	char **ipv6_addr;
};
struct dhcp6_lease_info *  get_dhcp6_lease_info(int *seg_times);
...
void delete_pool_lease(struct ipv6_pool *pool); 
