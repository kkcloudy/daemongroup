	...
	struct interface_info *info;
{
	...
	if (!quiet_interface_discovery)
		log_debug ("Sending on   Socket/%s%s%s",
		      info -> name,
		      (info -> shared_network ? "/" : ""),
		      (info -> shared_network ?
	...
	struct interface_info *info;
{
	...
	if (!quiet_interface_discovery)
		log_debug("Disabling output on Socket/%s%s%s",
		      info -> name,
		      (info -> shared_network ? "/" : ""),
		      (info -> shared_network ?
		       info -> shared_network -> name : ""));
	...
	struct interface_info *info;
{
	...
	if (!quiet_interface_discovery)
		log_debug("Listening on Socket/%s%s%s",
		      info -> name,
		      (info -> shared_network ? "/" : ""),
		      (info -> shared_network ?
		       info -> shared_network -> name : ""));
	...
	struct interface_info *info;
{
	...
	if (!quiet_interface_discovery)
		log_debug("Disabling input on Socket/%s%s%s",
		      info -> name,
		      (info -> shared_network ? "/" : ""),
		      (info -> shared_network ?
		       info -> shared_network -> name : ""));
