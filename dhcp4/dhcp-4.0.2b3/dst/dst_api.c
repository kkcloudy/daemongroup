#ifndef LINT
static const char rcsid[] = "$Header: /rdoc/dhcp4/dhcp-4.0.2b3/dst/dst_api.c,v 1.1.1.1 2009/11/17 10:01:58 qinhuasong Exp $";
#endif
...
dst_random(const int mode, unsigned wanted, u_char *outran)
{
	...
	case DST_RAND_SEMI: 
		...
		memset(buff,0,wanted+sizeof(u_int32_t));
