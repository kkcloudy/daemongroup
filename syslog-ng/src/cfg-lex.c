    ...
    void yy_switch_to_buffer  (YY_BUFFER_STATE  new_buffer )
{
	...
	/* 
	 CID 11059: Dereference after null check(var_deref_op: Dereferencing null pointer "yy_buffer_stack".)  no probelm
	 YY_DECL call yyensure_buffer_stack() alloc yy_buffer_stack when program start running.
	*/
...
void yypush_buffer_state (YY_BUFFER_STATE new_buffer )
{
	...
	if (YY_CURRENT_BUFFER)
		(yy_buffer_stack_top)++;
	/* 
	 CID 11060: Dereference after null check(var_deref_op: Dereferencing null pointer "yy_buffer_stack".)  no probelm
	 YY_DECL call yyensure_buffer_stack() alloc yy_buffer_stack when program start running.
	*/
	YY_CURRENT_BUFFER_LVALUE = new_buffer;
