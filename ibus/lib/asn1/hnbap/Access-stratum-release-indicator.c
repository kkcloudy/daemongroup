...
static asn_per_constraints_t asn_PER_type_Access_stratum_release_indicator_constr_1 = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  3,  3,  0,  5 }	/* (0..5,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_Access_stratum_release_indicator_value2enum_1[] = {
	{ 0,	3,	"r99" },
	{ 1,	5,	"rel-4" },
	{ 2,	5,	"rel-5" },
	{ 3,	5,	"rel-6" },
...
static unsigned int asn_MAP_Access_stratum_release_indicator_enum2value_1[] = {
	0,	/* r99(0) */
	1,	/* rel-4(1) */
	2,	/* rel-5(2) */
	3,	/* rel-6(3) */
...
static asn_INTEGER_specifics_t asn_SPC_Access_stratum_release_indicator_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_Access_stratum_release_indicator_tags_1[] = {
