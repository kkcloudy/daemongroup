...
static asn_TYPE_member_t asn_MBR_ErrorIndication_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Hnbap_ErrorIndication, protocolIEs),
	...
	{ ATF_POINTER, 1, offsetof(struct Hnbap_ErrorIndication, protocolExtensions),
...
static asn_TYPE_tag2member_t asn_MAP_ErrorIndication_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* protocolIEs at 379 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* protocolExtensions at 380 */
};
...
asn_TYPE_descriptor_t HNBAP_asn_DEF_ErrorIndication = {
	"ErrorIndication",
	"ErrorIndication",
	SEQUENCE_free,
	SEQUENCE_print,
