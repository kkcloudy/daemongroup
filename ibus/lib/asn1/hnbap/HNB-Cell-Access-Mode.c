...
static asn_per_constraints_t asn_PER_type_HNB_Cell_Access_Mode_constr_1 = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  2,  2,  0,  2 }	/* (0..2,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_HNB_Cell_Access_Mode_value2enum_1[] = {
	{ 0,	6,	"closed" },
	{ 1,	6,	"hybrid" },
	{ 2,	4,	"open" }
	/* This list is extensible */
};
static unsigned int asn_MAP_HNB_Cell_Access_Mode_enum2value_1[] = {
	0,	/* closed(0) */
	1,	/* hybrid(1) */
	2	/* open(2) */
	/* This list is extensible */
};
static asn_INTEGER_specifics_t asn_SPC_HNB_Cell_Access_Mode_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_HNB_Cell_Access_Mode_tags_1[] = {
