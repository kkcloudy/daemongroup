...
static asn_per_constraints_t asn_PER_type_CN_DomainIndicator_constr_1 = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_CN_DomainIndicator_value2enum_1[] = {
	{ 0,	9,	"cs-domain" },
	{ 1,	9,	"ps-domain" }
};
static unsigned int asn_MAP_CN_DomainIndicator_enum2value_1[] = {
	0,	/* cs-domain(0) */
	1	/* ps-domain(1) */
};
static asn_INTEGER_specifics_t asn_SPC_CN_DomainIndicator_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_CN_DomainIndicator_tags_1[] = {
