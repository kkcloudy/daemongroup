...
#ifndef	_ResetResourceAckItem_H_
#define	_ResetResourceAckItem_H_
...
typedef struct ResetResourceAckItem {
	IuSignallingConnectionIdentifier_t	 iuSigConId;
/* auto changed by perl script */
...
} ResetResourceAckItem_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ResetResourceAckItem;
...
#endif	/* _ResetResourceAckItem_H_ */
