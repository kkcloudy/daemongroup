...
#ifndef	_RAB_ToBeReleasedList_EnhancedRelocCompleteRes_H_
#define	_RAB_ToBeReleasedList_EnhancedRelocCompleteRes_H_
...
typedef struct RAB_ToBeReleasedList_EnhancedRelocCompleteRes {
/* auto changed by perl script */
A_SEQUENCE_OF(struct ProtocolIE_Container_139P0) list;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} RAB_ToBeReleasedList_EnhancedRelocCompleteRes_t;
...
#endif	/* _RAB_ToBeReleasedList_EnhancedRelocCompleteRes_H_ */
