...
static asn_TYPE_member_t asn_MBR_RAI_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RAI, iE_Extensions),
...
static int asn_MAP_RAI_oms_1[] = { 2 };
static ber_tlv_tag_t asn_DEF_RAI_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RAI_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* lAI at 1422 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* rAC at 1423 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* iE-Extensions at 1424 */
};
static asn_SEQUENCE_specifics_t asn_SPC_RAI_specs_1 = {
	...
	asn_MAP_RAI_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	2,	/* Start extensions */
	4	/* Stop extensions */
};
