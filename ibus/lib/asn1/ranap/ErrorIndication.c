...
#include "RANAP-ErrorIndication.h"

static asn_TYPE_member_t asn_MBR_ErrorIndication_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Ranap_ErrorIndication, protocolIEs),
	...
	{ ATF_POINTER, 1, offsetof(struct Ranap_ErrorIndication, protocolExtensions),
...
static asn_TYPE_tag2member_t asn_MAP_ErrorIndication_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* protocolIEs at 2552 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* protocolExtensions at 2553 */
};
...
asn_TYPE_descriptor_t RANAP_asn_DEF_ErrorIndication = {
	"ErrorIndication",
	"ErrorIndication",
