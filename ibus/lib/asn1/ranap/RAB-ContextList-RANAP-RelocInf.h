...
#ifndef	_RAB_ContextList_RANAP_RelocInf_H_
#define	_RAB_ContextList_RANAP_RelocInf_H_
...
typedef struct RAB_ContextList_RANAP_RelocInf {
/* auto changed by perl script */
A_SEQUENCE_OF(struct ProtocolIE_Container_139P0) list;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} RAB_ContextList_RANAP_RelocInf_t;
...
#endif	/* _RAB_ContextList_RANAP_RelocInf_H_ */
