...
#ifndef	_RAB_ContextFailedtoTransferList_H_
#define	_RAB_ContextFailedtoTransferList_H_
...
typedef struct RAB_ContextFailedtoTransferList {
/* auto changed by perl script */
A_SEQUENCE_OF(struct ProtocolIE_Container_139P0) list;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} RAB_ContextFailedtoTransferList_t;
...
#endif	/* _RAB_ContextFailedtoTransferList_H_ */
