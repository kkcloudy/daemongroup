...
#ifndef	_SNA_Access_Information_H_
#define	_SNA_Access_Information_H_
...
typedef struct SNA_Access_Information {
	AuthorisedPLMNs_t	 authorisedPLMNs;
/* auto changed by perl script */
...
#endif	/* _SNA_Access_Information_H_ */
