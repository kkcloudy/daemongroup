...
static asn_TYPE_member_t asn_MBR_Paging_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct Paging, protocolExtensions),
...
static int asn_MAP_Paging_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_Paging_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_Paging_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* protocolIEs at 2024 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* protocolExtensions at 2025 */
};
