...
static asn_TYPE_member_t asn_MBR_SecurityModeCommand_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SecurityModeCommand, protocolIEs),
	...
	{ ATF_POINTER, 1, offsetof(struct SecurityModeCommand, protocolExtensions),
...
static int asn_MAP_SecurityModeCommand_oms_1[] = { 1 };
...
static asn_TYPE_tag2member_t asn_MAP_SecurityModeCommand_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* protocolIEs at 1248 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* protocolExtensions at 1249 */
};
static asn_SEQUENCE_specifics_t asn_SPC_SecurityModeCommand_specs_1 = {
	...
	asn_MAP_SecurityModeCommand_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	1,	/* Start extensions */
	3	/* Stop extensions */
};
