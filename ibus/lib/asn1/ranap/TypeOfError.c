...
static asn_per_constraints_t asn_PER_type_TypeOfError_constr_1 = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  1,  1,  0,  1 }	/* (0..1,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_TypeOfError_value2enum_1[] = {
	{ 0,	14,	"not-understood" },
	{ 1,	7,	"missing" }
	/* This list is extensible */
};
static unsigned int asn_MAP_TypeOfError_enum2value_1[] = {
	1,	/* missing(1) */
	0	/* not-understood(0) */
	/* This list is extensible */
};
static asn_INTEGER_specifics_t asn_SPC_TypeOfError_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_TypeOfError_tags_1[] = {
