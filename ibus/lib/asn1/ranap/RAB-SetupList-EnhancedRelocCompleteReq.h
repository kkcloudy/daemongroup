...
#ifndef	_RAB_SetupList_EnhancedRelocCompleteReq_H_
#define	_RAB_SetupList_EnhancedRelocCompleteReq_H_
...
typedef struct RAB_SetupList_EnhancedRelocCompleteReq {
/* auto changed by perl script */
A_SEQUENCE_OF(struct ProtocolIE_Container_139P0) list;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} RAB_SetupList_EnhancedRelocCompleteReq_t;
...
#endif	/* _RAB_SetupList_EnhancedRelocCompleteReq_H_ */
