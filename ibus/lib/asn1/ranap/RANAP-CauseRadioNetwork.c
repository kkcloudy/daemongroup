...
static asn_per_constraints_t Ranap_asn_PER_type_CauseRadioNetwork_constr_1 = {
	{ APC_CONSTRAINED,	 6,  6,  1,  64 }	/* (1..64) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static ber_tlv_tag_t Ranap_asn_DEF_CauseRadioNetwork_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (2 << 2))
};
asn_TYPE_descriptor_t RANAP_asn_DEF_CauseRadioNetwork = {
	...
	Ranap_asn_DEF_CauseRadioNetwork_tags_1,
	sizeof(Ranap_asn_DEF_CauseRadioNetwork_tags_1)
		/sizeof(Ranap_asn_DEF_CauseRadioNetwork_tags_1[0]), /* 1 */
	Ranap_asn_DEF_CauseRadioNetwork_tags_1,	/* Same as above */
	sizeof(Ranap_asn_DEF_CauseRadioNetwork_tags_1)
		/sizeof(Ranap_asn_DEF_CauseRadioNetwork_tags_1[0]), /* 1 */
	&Ranap_asn_PER_type_CauseRadioNetwork_constr_1,
