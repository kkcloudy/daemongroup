...
static asn_per_constraints_t asn_PER_type_TriggeringMessage_constr_1 = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_TriggeringMessage_value2enum_1[] = {
	{ 0,	18,	"initiating-message" },
	{ 1,	18,	"successful-outcome" },
	{ 2,	21,	"unsuccessfull-outcome" },
	{ 3,	7,	"outcome" }
};
static unsigned int asn_MAP_TriggeringMessage_enum2value_1[] = {
	0,	/* initiating-message(0) */
	3,	/* outcome(3) */
	1,	/* successful-outcome(1) */
	2	/* unsuccessfull-outcome(2) */
};
static asn_INTEGER_specifics_t asn_SPC_TriggeringMessage_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_TriggeringMessage_tags_1[] = {
