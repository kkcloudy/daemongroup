...
static asn_TYPE_member_t asn_MBR_SecurityModeComplete_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SecurityModeComplete, protocolIEs),
	...
	{ ATF_POINTER, 1, offsetof(struct SecurityModeComplete, protocolExtensions),
...
static int asn_MAP_SecurityModeComplete_oms_1[] = { 1 };
...
static asn_TYPE_tag2member_t asn_MAP_SecurityModeComplete_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* protocolIEs at 1279 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* protocolExtensions at 1280 */
};
