...
static asn_per_constraints_t asn_PER_type_RIMRoutingAddress_constr_1 = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  1,  1,  0,  1 }	/* (0..1,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_RIMRoutingAddress_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RIMRoutingAddress, choice.targeteNB_ID),
...
static asn_TYPE_tag2member_t asn_MAP_RIMRoutingAddress_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* targetRNC-ID at 1629 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* gERAN-Cell-ID at 1630 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* targeteNB-ID at 1633 */
};
static asn_CHOICE_specifics_t asn_SPC_RIMRoutingAddress_specs_1 = {
