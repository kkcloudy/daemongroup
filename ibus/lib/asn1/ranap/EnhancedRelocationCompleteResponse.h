...
#ifndef	_EnhancedRelocationCompleteResponse_H_
#define	_EnhancedRelocationCompleteResponse_H_
...
} EnhancedRelocationCompleteResponse_t;
...
#endif	/* _EnhancedRelocationCompleteResponse_H_ */
