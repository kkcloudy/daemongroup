...
static asn_per_constraints_t Ranap_asn_PER_type_CauseMisc_constr_1 = {
	{ APC_CONSTRAINED,	 4,  4,  113,  128 }	/* (113..128) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static ber_tlv_tag_t Ranap_asn_DEF_CauseMisc_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_RANAP_CauseMisc = {
	...
	Ranap_asn_DEF_CauseMisc_tags_1,
	sizeof(Ranap_asn_DEF_CauseMisc_tags_1)
		/sizeof(Ranap_asn_DEF_CauseMisc_tags_1[0]), /* 1 */
	Ranap_asn_DEF_CauseMisc_tags_1,	/* Same as above */
	sizeof(Ranap_asn_DEF_CauseMisc_tags_1)
		/sizeof(Ranap_asn_DEF_CauseMisc_tags_1[0]), /* 1 */
	&Ranap_asn_PER_type_CauseMisc_constr_1,
