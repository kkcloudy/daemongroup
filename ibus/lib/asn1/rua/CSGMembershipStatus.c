...
static asn_per_constraints_t asn_PER_type_CSGMembershipStatus_constr_1 = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  1,  1,  0,  1 }	/* (0..1,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_CSGMembershipStatus_value2enum_1[] = {
	{ 0,	6,	"member" },
	{ 1,	10,	"non-member" }
	/* This list is extensible */
};
static unsigned int asn_MAP_CSGMembershipStatus_enum2value_1[] = {
	0,	/* member(0) */
	1	/* non-member(1) */
	/* This list is extensible */
};
static asn_INTEGER_specifics_t asn_SPC_CSGMembershipStatus_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_CSGMembershipStatus_tags_1[] = {
