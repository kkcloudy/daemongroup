...
typedef enum Rua_CauseRadioNetwork {
	CauseRadioNetwork_normal	= 0,
	CauseRadioNetwork_connect_failed	= 1,
	CauseRadioNetwork_network_release	= 2,
	CauseRadioNetwork_unspecified	= 3
	/*
	 * Enumeration is extensible
	 */
} Rua_e_CauseRadioNetwork;

/* CauseRadioNetwork */
typedef ENUMERATED_t	 Rua_CauseRadioNetwork_t;

/* Implementation */
extern asn_TYPE_descriptor_t RUA_asn_DEF_CauseRadioNetwork;
