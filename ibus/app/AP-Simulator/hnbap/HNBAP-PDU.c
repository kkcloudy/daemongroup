...
static asn_per_constraints_t asn_PER_type_HNBAP_PDU_constr_1 = {
...
static asn_TYPE_tag2member_t asn_MAP_HNBAP_PDU_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* initiatingMessage at 89 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* successfulOutcome at 90 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* unsuccessfulOutcome at 91 */
};
