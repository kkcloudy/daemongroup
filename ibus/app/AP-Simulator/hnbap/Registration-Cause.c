...
static asn_per_constraints_t asn_PER_type_Registration_Cause_constr_1 = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  1,  1,  0,  1 }	/* (0..1,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_Registration_Cause_value2enum_1[] = {
	{ 0,	14,	"emergency-call" },
	{ 1,	6,	"normal" }
	/* This list is extensible */
};
static unsigned int asn_MAP_Registration_Cause_enum2value_1[] = {
	0,	/* emergency-call(0) */
	1	/* normal(1) */
	/* This list is extensible */
};
static asn_INTEGER_specifics_t asn_SPC_Registration_Cause_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_Registration_Cause_tags_1[] = {
