...
static asn_TYPE_member_t asn_MBR_UERegisterReject_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UERegisterReject, protocolIEs),
	...
	{ ATF_POINTER, 1, offsetof(struct UERegisterReject, protocolExtensions),
...
static int asn_MAP_UERegisterReject_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_UERegisterReject_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UERegisterReject_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* protocolIEs at 309 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* protocolExtensions at 310 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UERegisterReject_specs_1 = {
	...
	asn_MAP_UERegisterReject_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	1,	/* Start extensions */
	3	/* Stop extensions */
};
