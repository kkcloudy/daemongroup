...
static asn_TYPE_member_t asn_MBR_UERegisterAccept_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UERegisterAccept, protocolIEs),
	...
	{ ATF_POINTER, 1, offsetof(struct UERegisterAccept, protocolExtensions),
...
static int asn_MAP_UERegisterAccept_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_UERegisterAccept_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UERegisterAccept_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* protocolIEs at 281 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* protocolExtensions at 282 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UERegisterAccept_specs_1 = {
	...
	asn_MAP_UERegisterAccept_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	1,	/* Start extensions */
	3	/* Stop extensions */
};
