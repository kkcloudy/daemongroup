...
static asn_TYPE_member_t asn_MBR_Cause_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct rua_Cause, choice.rua_radioNetwork),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct rua_Cause, choice.rua_transport),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct rua_Cause, choice.rua_protocol),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct rua_Cause, choice.rua_misc),
...
static asn_TYPE_tag2member_t asn_MAP_Cause_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* radioNetwork at 124 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* transport at 125 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* protocol at 126 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* misc at 127 */
};
