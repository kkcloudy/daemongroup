...
static asn_per_constraints_t asn_PER_type_CauseTransport_constr_1 = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  1,  1,  0,  1 }	/* (0..1,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_CauseTransport_value2enum_1[] = {
	{ 0,	30,	"transport-resource-unavailable" },
	{ 1,	11,	"unspecified" }
	/* This list is extensible */
};
static unsigned int asn_MAP_CauseTransport_enum2value_1[] = {
	0,	/* transport-resource-unavailable(0) */
	1	/* unspecified(1) */
	/* This list is extensible */
};
static asn_INTEGER_specifics_t asn_SPC_CauseTransport_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_CauseTransport_tags_1[] = {
